...
for index in "${!tags[@]}"; do
  ...
  if [[ -n "$previousTag" ]]; then
    fullChangelog="**Full Changelog**: https://github.com/abdalmoniem/CircularDurationView/compare/$previousTag...$tag"
  else
    fullChangelog="**Full Changelog**: https://github.com/abdalmoniem/CircularDurationView/commits/$tag"
  fi
